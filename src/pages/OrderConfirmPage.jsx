      ...
      <div style={s.card}>
        ...
        <div style={s.instruction}>
          ...
          <div style={s.step}>
            ...
            <span style={s.stepText}>Менеджер проверит оплату и передаст вам купленные товары</span>
          </div>
          <div style={s.step}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 'var(--space-lg)' }}>
          <a href="https://t.me/sjkzd" target="_blank" rel="noopener noreferrer" style={s.tgBtn}>
